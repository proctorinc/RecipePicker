      ...
      <section className="overflow-hidden rounded-[36px] border border-white/70 bg-white/70 shadow-soft">
        <div className="relative aspect-[16/10] sm:aspect-[16/8]">
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-8">
            ...
            <h2 className="max-w-4xl font-[family-name:var(--font-serif)] text-4xl font-semibold tracking-tight sm:text-5xl">
              {recipe.title}
            </h2>
          </div>
        </div>
        ...
        <CardContent className="flex flex-col gap-4 py-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {/*<ActionForm
              ...
              fields={{ recipeId: String(recipe.recipeId) }}
              buttonVariant="secondary"
            >
              Extract now
            </ActionForm>
            <ActionForm
              action={rerunRecipeAction}
              fields={{ recipeId: String(recipe.recipeId) }}
